...
@Component({
  selector: 'app-operatormain',
  templateUrl: './operatormain.component.html',
  styleUrls: ['./operatormain.component.css']
})
export class OperatormainComponent implements OnInit {
 ...
 ngOnInit() {
   ...
   this.loadSub_v1("2007-01-11", "2007-01-11");

   this.loadSub_v2("2007-01-11", "2007-01-11");
 }
...
function toolTipContent(e) {
 ...
 private loadSub_v1(startdate: string, enddate: string)
 {
  this.corerequest.startdate = "2007-01-1";
  this.corerequest.enddate = "2007-01-31";
  this.corerequest.sessionID = localStorage.getItem("sessionid");
 ...
 private loadSub_v2(startdate: string, enddate: string)
 {
  this.corerequest.startdate = "2007-01-1";
  this.corerequest.enddate = "2007-01-31";
  this.corerequest.sessionID = localStorage.getItem("sessionid");
